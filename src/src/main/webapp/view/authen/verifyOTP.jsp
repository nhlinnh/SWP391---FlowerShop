                        ...
                        <div class="customer-login-register register-pt-0">
                            ...
                            <div class="register-form">
                                <form action="${pageContext.request.contextPath}/authen?action=verify-otp" method="POST">
                                    <div class="form-fild">
                                        <p><label>OTP Code <span class="required">*</span></label></p>
                                ...
                                <div class="text-center mt-3">
                                    <span class="text-n50">Didn't receive the code?</span>
                                    <a href="${pageContext.request.contextPath}/authen?action=enter-email" 
